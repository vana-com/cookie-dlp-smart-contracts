...
import { DOH } from "../typechain-types";
...
describe("ERC20Swapper", () => {
  ...
  const deploy = async () => {
    ...
    dat = await ethers.deployContract("DOH", ["Custom Data Autonomy Token", "CDAT", owner.address]);
  ...
  describe("DLPT - basic", () => {
    ...
    it("should have correct params after deploy", async function () {
      ...
      (await dat.name()).should.eq("Custom Data Autonomy Token");
      (await dat.symbol()).should.eq("CDAT");
